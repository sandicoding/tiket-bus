        ...
        <div class="panel-body">
            <div class="row-table-bordered">
                <div class="col-md-2" style="margin-top: 50px;">
                    <img src="images/logo2.png" class="img-responsive pull-left" style="max-height:150px;display:inline">
                </div>
                <br>
                
                <div class="col-md-4">
                    <font size="4"><b><p class="text-center">P.O. Tiket Buss jaya</p></font>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php 
                                        ...
                                        $query  = mysqli_query($conn, "SELECT * FROM kursi ")or die(mysqli_error($conn));
                                        $rowcount = mysqli_num_rows($query);
                                        
                                         while($data = mysqli_fetch_array($query) ){
                                         if($data["id_pesan"] == $id_pesan){
                                         echo $data['kode_kursi']." | ";
                                         }else {
                                             echo 'tiket anda kadaluarsa';
                                         }    
                                        }
                                ...
                                <td>
                                    <?php
                                        $query  = mysqli_query($conn, "SELECT total FROM tiket WHERE id_pesan = '$id_pesan'")or die(mysqli_error($conn));
