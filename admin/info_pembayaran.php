						...
						$query = mysqli_query($conn, "SELECT * FROM pembayaran")or die(mysqli_error());
										...
										{	
											...
											while($data = mysqli_fetch_array($query)){	
												...
												echo '<td><a href=admin2.php?halaman=edit_pembayaran&&id='.$data['id'].'><span class="btn btn-primary">Edit</a></td>';
												echo '<td><a href=delete_info.php?id='.$data['id'].'><span class="btn btn-danger">Delete</span></a></td>';
												echo '</tr>';
												$no++;	
											}
										}
	...
	<div class="modal-dialog">
    	...
    	<div class="modal-content">
      		...
      		<div class="modal-body">
      			<form action="../config/add_pembayaran.php" class="form-horizontal" method="post">
