<?php
	...
	$edit  = "SELECT * FROM pembayaran where id='$id'";
...
<div class="col-md-10">
    ...
    <br><br><br>
    <form class="form-horizontal" action="../config/update_rekening.php" method="POST">
        ...
        <div class="form-group">
            <label class="control-label col-sm-4" for="rute">Nama :</label>
            <div class="col-sm-6">
                <input type="rute" class="form-control" name="nama" value="<?php echo $data['atas_nama']; ?>">
            </div>
        </div>
