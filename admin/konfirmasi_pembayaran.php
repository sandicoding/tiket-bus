			...
			<input type="hidden" name="id_pesan" value="<?php echo $data['id_pesan']; ?>">
				<table class="table table-striped-bordered">
					...
					<tr>
						...
						<td width="50">:</td>
						<td><img src="../<?php echo $data['respons']; ?>" width="450px" height="400px"></td>
					</tr>
					<tr>
						<td width="200"></td>
						<td><a href="admin2.php?halaman=bukti_bayar" class="btn btn-warning">Batal</a></td>
