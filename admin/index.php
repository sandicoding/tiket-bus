            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" action="../config/proses_login.php" name="admin" method="post" onSubmit="return validasi(hits)">
                    <div class="form-group">
                      <input type="txt" class="form-control form-control-user" id="exampleInputEmail" name="username" aria-describedby="emailHelp" placeholder="Enter Username">
                    </div>
                    <div class="form-group">
