<br>
    <h3 class="page-header">
        <div align="center" style="margin-top: 50px;">Silahkan Pesan Tiket</div>
    </h3>
    <br><br><br>
    <form class="form-horizontal" action="config/proses_pesan.php" method="POST">
       
                <input type="hidden" class="form-control" name="id" value="<?php echo @$_SESSION['id_user']; ?>" >
        ...
        <div class="form-group">
            ...
            <?php }else { ?>
                ...
                <p>anda harus login terdahulu untuk memesan tiket!</p>
            <?php } ?>
            </div>
        </div>
    </form>
