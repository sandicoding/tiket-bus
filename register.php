            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" action="config/proses_register.php" name="admin" method="post" onSubmit="return validasi(hits)">
                    ...
                    <div class="form-group">
                      <input type="number" class="form-control form-control-user" id="exampleInputTelepon" name="telepon" placeholder="Telepon">
                    </div>
                    ...
                    <center><button class="btn btn-primary btn-user type="submit">Buat akun</button></center>
                    <hr>
                  </form>
                  <hr>
                  <!-- <div class="text-center">
